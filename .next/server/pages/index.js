...
const getStaticProps = async () => {
  ...
  const client = await external_mongodb_["MongoClient"].connect('mongodb+srv://kubalinio:qwer1234@cluster0.azkhkts.mongodb.net/meetups?retryWrites=true&w=majority');
  const db = client.db();
